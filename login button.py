...
username = Entry(root, width=30, borderwidth=10, fg="black", bg="#84BA48", font=("Times New Roman", 20, "bold"), justify=LEFT)
...
password = Entry(root, width=30, borderwidth=10, fg="white", bg="#84BA48", font=("Times New Roman", 20, "bold"), justify=LEFT)
...
def login_successful():
    messagebox.showinfo("ADMIN","You have logged in successfully!")
    root.destroy()
    os.system("main.py")
...
def new_registration():
    ...
    def register():
        ...
        # Insert into table
        c.execute("INSERT INTO reg_data VALUES (:user_name, :address, :password, :confirm_password)", {
...
new_user_reg_label = Button(root, width=20, borderwidth=10, bg="white", text="For New User Click Here!", font=("Times New Roman", 22, "bold"), command=new_registration)\
    .place(x=250, y=350)
